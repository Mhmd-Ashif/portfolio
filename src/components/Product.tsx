  ...
  return (
    <div className="py-10">
      ...
      >
        ...
        />
        <div className="absolute bottom-0  w-full [mask-image:linear-gradient(to_bottom,transparent,white)]" />
      </motion.div>
        ...
        {product.images.map((image, idx) => (
          ...
          >
            <Image
              ...
              height="1000"
              width="1000"
              className="h-14 w-16  object-cover object-top mr-4 mb-r border rounded-lg border-neutral-100"
            />
          </button>
        ))}
      </div>
